...
ENTITY_SCHEMAS = {
    ...
    "departments": {
        "required_columns": ["code", "faculty_code"],
        "column_mappings": {
    ...
    "programmes": {
        "required_columns": ["code", "department_code", "duration_years"],
        "column_mappings": {
            "programme_name": "name",
            "program_name": "name",
            "programme_code": "code",
    ...
    "rooms": {
        "required_columns": ["code", "building_code", "capacity", "exam_capacity"],
        "column_mappings": {
            "room_code": "code",
            "room_name": "name",
            "ac": "has_ac",
    ...
    "staff": {
        "required_columns": ["staff_number", "department_code"],
        "column_mappings": {
