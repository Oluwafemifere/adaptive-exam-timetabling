...
class Exam(Base):
    ...
    session: Mapped["AcademicSession"] = relationship("AcademicSession", back_populates="exams")
    time_slot: Mapped["TimeSlot"] = relationship("TimeSlot", back_populates="exams")
    exam_rooms: Mapped[List["ExamRoom"]] = relationship("ExamRoom", back_populates="exam")
    invigilators: Mapped[List["ExamInvigilator"]] = relationship("ExamInvigilator", back_populates="exam")
...
class TimeSlot(Base):
    ...
    staff_unavailability: Mapped[List["StaffUnavailability"]] = relationship("StaffUnavailability", back_populates="time_slot")
...
class Staff(Base):
    ...
    invigilations: Mapped[List["ExamInvigilator"]] = relationship("ExamInvigilator", back_populates="staff")
    unavailability: Mapped[List["StaffUnavailability"]] = relationship("StaffUnavailability", back_populates="staff")
...
class ExamInvigilator(Base, TimestampMixin):
    ...
    room: Mapped["Room"] = relationship("Room")  # Simple relationship without back_populates for now
...
class StaffUnavailability(Base):
    ...
    session: Mapped["AcademicSession"] = relationship("AcademicSession", back_populates="staff_unavailability")
    time_slot: Mapped["TimeSlot"] = relationship("TimeSlot", back_populates="staff_unavailability")
